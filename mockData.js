  ...
  en: {
    navigation: {
      mainMenus: [
        ...
        { id: "menu-explore", label: "Explore Destinations", actionUrl: "/explore" },
        { id: "menu-offers", label: "Special Offers", actionUrl: "/offers" },
        { id: "menu-wellness", label: "Wellness & Spa", actionUrl: "/wellness" },
        { id: "menu-dining", label: "Dining Experiences", actionUrl: "/dining" }
      ],
      utilities: {
        languages: {
    ...
    footer: {
      ...
      downloadApp: {
        ...
        subtitle: "Download our mobile app to book and manage stays seamlessly.",
        stores: [
          { label: "App Store", actionUrl: "https://apps.apple.com/app/minor-hotels", iconUrl: "https://cdn.example.com/icons/app-store.png" },
          { label: "Google Play", actionUrl: "https://play.google.com/store/minor-hotels", iconUrl: "https://cdn.example.com/icons/google-play.png" }
        ]
      },
      explore: {
        title: "Explore",
      ...
      connect: {
        title: "Connect",
        links: [
          { label: "Facebook", actionUrl: "https://facebook.com/minorhotels", iconKey: "facebook" },
          { label: "Instagram", actionUrl: "https://instagram.com/minorhotels", iconKey: "instagram" },
          { label: "LinkedIn", actionUrl: "https://linkedin.com/company/minorhotels", iconKey: "linkedin" }
        ]
      },
      legalAndCopyright: {
        links: [
      ...
      containers: [
        {
          ...
          data: {
            ...
            subtitle: "Unforgettable journeys across our globally curated collection of resorts.",
        ...
        },
        {
          ...
          data: {
            ...
            subtitle: "A diverse portfolio of luxury hospitality experiences tailored for you.",
            brands: [
              {
        ...
        },
        {
          ...
          data: {
            ...
            subtitle: "Enjoy exclusive rewards and guarantees every time you book through our website.",
            benefits: [
              { number: "01", text: "Best Rate Guarantee", description: "Find a lower rate elsewhere within 24 hours and we will match it and give an extra 10% off." },
              { number: "02", text: "Exclusive Member Rates", description: "Sign in as a DISCOVERY member to save an additional 10% or more on all bookings." },
              { number: "03", text: "Direct Stay Perks", description: "Enjoy complimentary high-speed Wi-Fi, flexible cancellation, and priority early check-in." }
            ]
          }
        }
      ]
    ...
    searchConfig: {
      ...
      searchFields: {
        destination: { id: "dest", label: "Destination", placeholder: "Where to?", iconUrl: "https://cdn.example.com/icons/map-pin.svg" },
        dates: { id: "dates", label: "Dates", placeholder: "Check-in - Check-out", iconUrl: "https://cdn.example.com/icons/calendar.svg" },
        rooms: { id: "rooms", label: "Guests & Rooms", placeholder: "1 Room, 2 Adults", iconUrl: "https://cdn.example.com/icons/guests.svg" }
      },
      buttons: {
        submitLabel: "Search",
    ...
    staticResources: {
      home: {
        ...
        search_button: { text: "Search Hotels", iconUrl: "https://cdn.example.com/icons/search.svg" },
        booking_guarantee: { text: "Best Rate Guarantee", iconUrl: "https://cdn.example.com/icons/shield.svg" }
      },
      support: {
        contact_us: { text: "Contact Support", iconUrl: "https://cdn.example.com/icons/mail.svg" },
        faq: { text: "Frequently Asked Questions", iconUrl: "https://cdn.example.com/icons/info.svg" }
      }
    }
  },
  th: {
    navigation: {
      mainMenus: [
        ...
        { id: "menu-explore", label: "สำรวจจุดหมายปลายทาง", actionUrl: "/explore" },
        { id: "menu-offers", label: "ข้อเสนอพิเศษ", actionUrl: "/offers" },
        { id: "menu-wellness", label: "เวลเนสและสปา", actionUrl: "/wellness" },
        { id: "menu-dining", label: "ห้องอาหารและประสบการณ์ทานอาหาร", actionUrl: "/dining" }
      ],
      utilities: {
        languages: {
          iconUrl: "https://cdn.example.com/icons/globe.svg",
    ...
    footer: {
      ...
      downloadApp: {
        ...
        subtitle: "ดาวน์โหลดแอปมือถือของเราเพื่อจองและจัดการการเข้าพักได้อย่างง่ายดาย",
        stores: [
          { label: "App Store", actionUrl: "https://apps.apple.com/app/minor-hotels", iconUrl: "https://cdn.example.com/icons/app-store.png" },
          { label: "Google Play", actionUrl: "https://play.google.com/store/minor-hotels", iconUrl: "https://cdn.example.com/icons/google-play.png" }
        ]
      ...
      containers: [
        {
          ...
          data: {
            ...
            subtitle: "การเดินทางที่น่าจดจำ ณ รีสอร์ทหรูระดับโลกที่คัดสรรมาเพื่อคุณ",
        ...
        },
        {
          ...
          data: {
            ...
            subtitle: "ค้นพบสถานที่ท่องเที่ยวที่ไม่เหมือนใครและคู่มือการเดินทางที่คัดสรรมาแล้ว",
            items: [
              {
                label: "ภูเก็ต",
        ...
        },
        {
          ...
          data: {
            ...
            subtitle: "แบรนด์โรงแรมหลากหลายรูปแบบที่ได้รับการออกแบบมาให้ตอบรับกับความต้องการของคุณ",
            brands: [
              {
        ...
        },
        {
          ...
          data: {
            ...
            subtitle: "เพลิดเพลินกับรางวัลและสิทธิประโยชน์พิเศษทุกครั้งที่คุณจองผ่านเว็บไซต์ของเรา",
            benefits: [
              { number: "01", text: "รับประกันราคาดีที่สุด", description: "หากคุณพบราคาที่ถูกกว่าที่อื่นภายใน 24 ชั่วโมง เรายินดีปรับราคาให้เท่ากันและลดเพิ่มอีก 10%" },
              { number: "02", text: "ราคาพิเศษสำหรับสมาชิก", description: "เข้าสู่ระบบในฐานะสมาชิก DISCOVERY เพื่อประหยัดเพิ่มอีก 10% หรือมากกว่าในการจองทุกครั้ง" },
              { number: "03", text: "สิทธิพิเศษการจองตรง", description: "เพลิดเพลินกับบริการ Wi-Fi ความเร็วสูงฟรี นโยบายการยกเลิกที่ยืดหยุ่น และสิทธิ์เช็คอินก่อนเวลา" }
            ]
          }
        }
      ]
    ...
    searchConfig: {
      ...
      searchFields: {
        destination: { id: "dest", label: "จุดหมายปลายทาง", placeholder: "คุณอยากไปที่ไหน?", iconUrl: "https://cdn.example.com/icons/map-pin.svg" },
        dates: { id: "dates", label: "วันที่เข้าพัก", placeholder: "เช็คอิน - เช็คเอาท์", iconUrl: "https://cdn.example.com/icons/calendar.svg" },
        rooms: { id: "rooms", label: "ผู้เข้าพัก & ห้องพัก", placeholder: "1 ห้อง, ผู้ใหญ่ 2 ท่าน", iconUrl: "https://cdn.example.com/icons/guests.svg" }
      },
      buttons: {
        submitLabel: "ค้นหา",
    ...
    staticResources: {
      home: {
        welcome_title: { text: "ยินดีต้อนรับสู่ เครือไมเนอร์ โฮเทลส์", iconUrl: null },
        search_button: { text: "ค้นหาโรงแรม", iconUrl: "https://cdn.example.com/icons/search.svg" },
        booking_guarantee: { text: "รับประกันราคาดีที่สุด", iconUrl: "https://cdn.example.com/icons/shield.svg" }
      },
      support: {
        contact_us: { text: "ติดต่อฝ่ายบริการลูกค้า", iconUrl: "https://cdn.example.com/icons/mail.svg" },
        faq: { text: "คำถามที่พบบ่อย", iconUrl: "https://cdn.example.com/icons/info.svg" }
      }
    }
  }
};
...
const destinations = [
  { id: "dest-phuket", title: "Phuket", destinationType: "city", propertyCount: 15, countryName: "Thailand", regionName: "Southeast Asia" },
  { id: "dest-bangkok", title: "Bangkok", destinationType: "city", propertyCount: 12, countryName: "Thailand", regionName: "Southeast Asia" },
  { id: "dest-samui", title: "Koh Samui", destinationType: "city", propertyCount: 8, countryName: "Thailand", regionName: "Southeast Asia" },
  { id: "dest-bali", title: "Bali", destinationType: "city", propertyCount: 6, countryName: "Indonesia", regionName: "Southeast Asia" },
  { id: "dest-maldives", title: "Maldives", destinationType: "region", propertyCount: 5, countryName: "Maldives", regionName: "Indian Ocean" },
  { id: "dest-dubai", title: "Dubai", destinationType: "city", propertyCount: 4, countryName: "United Arab Emirates", regionName: "Middle East" }
];
...
const propertyCatalog = {
  "AN-TH-004": {
    ...
    countryCode: "TH",
    tags: ["WELLNESS", "FAMILY", "PET_FRIENDLY"],
    ...
    amenities: {
      featured: [
        { code: "BUSINESS_SERVICES", label: "Business services", icon: "business-services" },
    ...
    location: {
      address: { addressLine1: "25/25 Moo 4, Koh Yao Yai", city: "Phuket", province: "Phang Nga", postalCode: "82160", countryCode: "TH" },
    ...
    rooms: [
      {
        ...
        description: "An ultra-luxurious private pool villa overlooking the Andaman Sea.",
        ...
        summaryFeatures: [{ code: "OCEAN_VIEW", label: "Ocean View", icon: "ocean" }],
        highlights: [{ code: "BUTLER_SERVICE", label: "24-Hour Butler Service", icon: "butler" }],
            ...
            rates: [
              {
                ...
                codeForReservation: { propertyCode: "AN-TH-004", roomCode: "SUITE-VILLA-01", ratePlanCode: "BB-FLEX", rateGroupCode: "PUBLIC-FLEX" },
                ...
                pricing: { currency: "THB", total: 12040, pricePerNight: 12040, numberOfNights: 1 },
                cancellation: { refundable: true, freeCancellation: true, freeCancellationDeadline: "2026-07-10T14:00:00Z", timezone: "Asia/Bangkok", displayText: "Free cancellation.", penaltyAmount: 12040 },
                loyalty: { earnAmount: 1204, redeemableAmount: 12040, currency: "D-POINTS" },
                directBookingBenefits: [{ code: "EARLY_CHECKIN", label: "Priority Early Check-in", icon: "clock" }]
              }
            ]
          }
        ]
  ...
  "AV-TH-001": {
    ...
    amenities: {
      featured: [
        { code: "BUSINESS_SERVICES", label: "Meeting facilities", icon: "business-services" },
    ...
    location: {
      address: { addressLine1: "257 Charoennakorn Road, Thonburi", city: "Bangkok", province: "Bangkok", postalCode: "10600", countryCode: "TH" },
    ...
    rooms: [
      {
        ...
        description: "A sleek, modern room with floor-to-ceiling windows boasting panoramic views of Chao Phraya River.",
        bedConfiguration: [{ bedType: "KING", label: "King Bed", quantity: 1 }],
        maximumOccupancy: { totalGuests: 2, adults: 2, children: 0 },
        size: { value: 30, unit: "sqm" },
        remainingRooms: 15,
        roomCategoryCode: "ROOM",
        summaryFeatures: [{ code: "RIVER_VIEW", label: "River View", icon: "river" }],
        highlights: [{ code: "WORK_STATION", label: "Dedicated Workspace", icon: "desk" }],
        amenities: [{ code: "WIFI", label: "Free High-Speed Wi-Fi", icon: "wifi" }],
            ...
            rates: [
              {
                ...
                rateGroupCode: "PUBLIC-FLEX",
                codeForReservation: { propertyCode: "AV-TH-001", roomCode: "ROOM-AVANI-01", ratePlanCode: "RO-FLEX", rateGroupCode: "PUBLIC-FLEX" },
                rateName: "Best Flexible Rate (Room Only)",
                rateDescription: "Standard room rate. Cancel up to 1 day prior.",
                badges: ["FREE_CANCELLATION"],
                pricing: { currency: "THB", total: 4500, pricePerNight: 4500, numberOfNights: 1 },
                cancellation: { refundable: true, freeCancellation: true, freeCancellationDeadline: "2026-07-12T14:00:00Z", timezone: "Asia/Bangkok", displayText: "Free cancellation.", penaltyAmount: 4500 },
                loyalty: { earnAmount: 450, redeemableAmount: 4500, currency: "D-POINTS" },
                directBookingBenefits: [{ code: "EARLY_CHECKIN", label: "Priority Early Check-in", icon: "clock" }]
              }
            ]
          }
...
const BRANDS = [
  { name: "Anantara", code: "AN", path: "/brands/anantara.svg", domain: "cdn.example.com" },
  { name: "Avani", code: "AV", path: "/brands/avani.svg", domain: "cdn.example.com" },
  { name: "Tivoli", code: "TV", path: "/brands/tivoli.svg", domain: "cdn.example.com" },
  { name: "Oaks", code: "OK", path: "/brands/oaks.svg", domain: "cdn.example.com" },
  { name: "NH Hotels", code: "NH", path: "/brands/nh.svg", domain: "cdn.example.com" }
];

const LOCATIONS = [
  { city: "Phuket", countryCode: "TH", country: "Thailand", province: "Phuket", postalCode: "83000" },
  { city: "Bangkok", countryCode: "TH", country: "Thailand", province: "Bangkok", postalCode: "10110" },
  { city: "Koh Samui", countryCode: "TH", country: "Thailand", province: "Surat Thani", postalCode: "84320" },
  { city: "Chiang Mai", countryCode: "TH", country: "Thailand", province: "Chiang Mai", postalCode: "50000" },
  { city: "Bali", countryCode: "ID", country: "Indonesia", province: "Bali", postalCode: "80361" },
  { city: "Maldives", countryCode: "MV", country: "Maldives", province: "Male Atoll", postalCode: "20000" },
  { city: "Dubai", countryCode: "AE", country: "United Arab Emirates", province: "Dubai", postalCode: "00000" },
  { city: "Lisbon", countryCode: "PT", country: "Portugal", province: "Lisboa", postalCode: "1100" },
  { city: "Rome", countryCode: "IT", country: "Italy", province: "Roma", postalCode: "00184" },
  { city: "London", countryCode: "GB", country: "United Kingdom", province: "London", postalCode: "SW1A" }
];

const ADJECTIVES = ["Grand", "Luxury", "Riverside", "Resort & Spa", "Palace", "Boutique Hotel", "Suites", "Villas", "Haven", "Sanctuary"];

const TAG_COMBOS = [
  ["WELLNESS", "FAMILY", "PET_FRIENDLY"],
  ["CITY", "SKYLINE_POOL", "DINING"],
  ["BEACHFRONT", "LUXURY", "HONEYMOON"],
  ["NATURE", "ADVENTURE", "ECO_FRIENDLY"],
  ["BUSINESS", "CONFERENCE", "SPA"]
];
...
while (Object.keys(propertyCatalog).length < 50) {
  ...
  propertyCatalog[propertyCode] = {
    ...
    location: {
      ...
      travelInformation: [`Conveniently accessible from ${loc.city} central terminals.`],
    ...
    rooms: [
      {
        ...
        remainingRooms: 8,
        roomCategoryCode: "ROOM",
        summaryFeatures: [{ code: "WIFI", label: "High-Speed Wi-Fi", icon: "wifi" }],
        highlights: [],
        amenities: [],
        bathroomAmenities: [],
        media: {
            ...
            rates: [
              {
                ...
                badges: ["FREE_CANCELLATION"],
                pricing: { currency: "THB", total: basePrice, pricePerNight: basePrice, numberOfNights: 1 },
                cancellation: { refundable: true, freeCancellation: true, freeCancellationDeadline: "2026-07-12T14:00:00Z", timezone: "UTC", displayText: "Free cancellation.", penaltyAmount: basePrice },
                loyalty: { earnAmount: basePrice * 0.1, redeemableAmount: basePrice, currency: "D-POINTS" },
